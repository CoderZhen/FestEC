...
public class SignUpDelegate extends LatteDelegate {
    private static final String TAG = "SignUpDelegate-vv";

    TextInputEditText mName, mEmail, mPhone, mPassword, mRePassword;
    ...
    private void initView(View rootView) {
        ...
        mTvSignIn = rootView.findViewById(R.id.tv_link_sign_in);
    }
}
